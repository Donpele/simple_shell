...
/**
 * write_history - the function that creates a file,
...
int write_history(info_t *info)
{
	...
	ad = open(filename, O_CREAT | O_TRUNC | O_RDWR, 0644);
	free(filename);
	if (ad == -1)
		return (-1);
...
/**
 * build_history_list - the function that adds entry to a history linked list
...
/**
 * renumber_history - the function that renumbers
